...
<HEAD>
	...
	<script type="text/javascript">
		...
		function delConfirm(cid) {
			...
			if(b){//点击了确定按钮
				//alert(cid)
				window.location.href = "${pageContext.request.contextPath}/categoryDel?cid=" + cid;
			}
		}
	</script>
</HEAD>
	...
	<tr>
		<td class="ta_01" align="center" bgColor="#f5fafe">
			<table cellspacing="0" cellpadding="1" rules="all"
				...
				<c:forEach items="${categoryList}" var="cg"  varStatus="vs">
					...
					<tr onmouseover="this.style.backgroundColor = 'white'"
						...
						<td style="CURSOR: hand; HEIGHT: 22px" align="center"
							width="17%">${cg.cname}</td>
						<td align="center" style="HEIGHT: 22px"><a
								href="${ pageContext.request.contextPath }/categoryEdit?cid=${cg.cid}">
							<img
						...
						<td align="center" style="HEIGHT: 22px"><a
								href="" onclick="delConfirm('${cg.cid}')">
